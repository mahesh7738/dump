...
export default function Post({ post }) {
  ...
  useEffect(() => {
    if (post[0]?.slug) {
      router.push(`https://archaeologyworlds.com/${post[0]?.slug}`);
    }
  }, [post[0]?.slug]);
...
//     `https://archaeologyworlds.com/wp-json/wp/v2/posts?slug=${slug}`
//   );
//   const post = res?.data;
//   return {
//     props: {
...
//   const res = await axios.get(
//     "https://archaeologyworlds.com/wp-json/wp/v2/posts?_embed&per_page=100"
//   );
